...
class TestLoginPage:
    ...
    def test_login_via_login_button_show_main_page(self, driver: WebDriver):
    ...
    def test_login_via_profile_show_main_page(self, driver: WebDriver):
    ...
    def test_login_via_registration_page_show_main_page(self, driver: WebDriver):
    ...
    def test_login_via_forgot_password_page_show_main_page(self, driver: WebDriver):
